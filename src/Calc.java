...
class Calc {
    ...
    public static String calc(String input) throws Exception {
        ...
        String result;
        boolean isRoman;
        String[] operands = input.replaceAll("\\s", "").split("[+\\-*/]");
        if (operands.length != 2) throw new Exception("Должны быть две цифры");
        oper = detectOperation(input);
        if (oper == null) throw new Exception("Такой операции не существует");
